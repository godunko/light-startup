...
--  reads as 0.
   ...
   type CKGR_MOR_Register_Value is record
   ...
   type CKGR_MOR_Register is new CKGR_MOR_Register_Value
     with Volatile_Full_Access;
   ...
   type PMC_MCKR_Register_Value is record
      --  Master Clock Source Selection
   ...
   type PMC_MCKR_Register is new PMC_MCKR_Register_Value
     with Volatile_Full_Access;
