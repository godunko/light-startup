...
package body System_Arduino_Due is
   ...
   procedure Startup_Setup_Clocks
     with Export, External_Name => "Startup_Setup_Clocks";
   pragma Weak_External (Startup_Setup_Clocks);
   --  Default system clocks setup subprogram. It might be overridden by the
   --  application.
   --
   --  Note, this code is executed at startup before initialized and zeroed
   ...
   procedure Startup_Setup_Clocks is
   begin
   ...
   end Startup_Setup_Clocks;

end System_Arduino_Due;
